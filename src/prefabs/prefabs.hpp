...
namespace prefabs
{
	...
	const inline ProjectilePrefab lasherShell{getDataPath("graphics/projectiles/shell_small_green.png"), "lasher_shell", 20, 2, 40, 14, 5.f};
	const inline ProjectilePrefab hammerheadShell{getDataPath("graphics/projectiles/bomblet2.png"), "hammerhead_shell", 20, 5, 30, 20.5f, 3.f};
	const inline ProjectilePrefab scarabShell{getDataPath("graphics/projectiles/rift_torpedo.png"), "scarab_shell", 20, 5, 30, 20, 3.f};
	...
	const inline ShipPrefab hammerhead{getDataPath("graphics/ships/hammerhead_dd.png"), "hammerhead", 3.8f, 2500, 20.f, 0.38f, 300, hammerheadShell};
	const inline ShipPrefab lasher{getDataPath("graphics/ships/lasher_ff.png"), "lasher", 4.5f, 1200, 20.f, 0.45f, 60, lasherShell};
	const inline ShipPrefab wolf{getDataPath("graphics/ships/wolf_ff.png"), "wolf", 5.5f, 600, 6, 0.7f, 40, torpedo};
	const inline ShipPrefab scarab{getDataPath("graphics/ships/scarab.png"), "scarab", 5, 1000, 20.f, 0.5f, 50, scarabShell};
